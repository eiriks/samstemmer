...
DATABASES = {
    'default': {
        ...
        'NAME': 'stortinget',            # Or path to database file if using sqlite3.
        'USER': 'databasebrukernavn',                  # Not used with sqlite3.
        'PASSWORD': 'databasepassord',              # Not used with sqlite3.
...
# system time zone.
TIME_ZONE = 'Europe/Oslo' # 'America/Chicago'
...
SECRET_KEY = 'bwutsgold-8jhfk&nt23(kynehg7@v7mv!zk4@##mlll4(4(53'
