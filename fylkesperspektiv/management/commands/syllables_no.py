...
for item in subSyllableIf:
    item = item #.decode("utf-8") # eirik - unicode !
...
for line in specialSyllables_no.splitlines():
    ...
    if line:
        ...
        syllablesInFile[_stripWord(unicode(toks[0],"latin-1"))] = int(toks[1])

def count(word):
    #print word
    #word = unicode(word,"utf-8").encode("utf-8")# eirik, unicode!
    ...
    for c in word: #.decode("utf-8"): #eirik - unicode! 
